...
FEDORA_SOURCES := https://src.fedoraproject.org/rpms/initial-setup/raw/f$(subst fc,,$(DIST))/f/sources
SRC_FILES := \
             initial-setup-$(VERSION).tar.gz
...
SRC_URLS := \
            https://ftp.qubes-os.org/distfiles/initial-setup-$(VERSION).tar.gz
